...
const allProducts = [
  {
    ...
    image: "/images/1.jpg",
    description:
      "Paris Premium dengan bahan yang lebih flowy, soft dan tegak saat dipakai",
    category: "square",
    size: "All Size",
    details: [
  ...
  },
  {
    ...
    image: "/images/2.jpg",
    description:
      "Paris Premium dengan bahan yang flowy, soft, dan tegak saat dipakai",
    category: "Square",
    size: "All Size",
    details: [
      "Material Paris Premium",
  ...
  },
  {
    ...
    image: "/images/12.jpg",
    description:
      "Ciput terbuat dari bahan kaos Rayon yang halus, lembut, dan nyaman dipakai",
    category: "ciput",
    size: "All Size",
    details: [
...
export default function SingleProductPembayaran({
  params,
}: PembayaranPageProps) {
  ...
  // Check if product already has color in its name
  const hasColorInName =
    product?.name.toLowerCase().includes("black") ||
    product?.name.toLowerCase().includes("navy") ||
    product?.name.toLowerCase().includes("taupe") ||
    product?.name.toLowerCase().includes("dark grey") ||
    product?.name.toLowerCase().includes("abu-abu") ||
    product?.name.toLowerCase().includes("milo") ||
    product?.name.toLowerCase().includes("mocca") ||
    product?.name.toLowerCase().includes("nude") ||
                ...
                <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 p-4 border rounded-lg">
                  ...
                  <div className="flex-1 w-full text-center sm:text-left sm:mt-0">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 mt-2">
                      ...
                      <span className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded inline-block w-fit mx-auto sm:mx-0">
                        {product.size}
                      </span>
                    </div>

                    {/* Color Selection - Only show if product doesn't have color in name */}
                    {!hasColorInName && (
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2 pt-4">
                  <Button
                    ...
                    disabled={!hasColorInName && !selectedColor}
                  >
